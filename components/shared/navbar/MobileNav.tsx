  ...
  return (
    <Sheet>
      ...
      <SheetContent
        side={'left'}
        className={
          'background-light900_dark200 flex max-w-80 flex-col overflow-y-auto border-none'
        }
      >
        <SheetClose asChild>
            ...
            <div className={'flex flex-col gap-3'}>
              <SheetClose asChild>
                <Link href="/sign-in " className="focus:outline-none">
                  <Button
                    className={
                      'small-medium btn-secondary min-h-[41px] w-full rounded-none px-4 py-3 shadow-none outline-none'
                    }
                  >
      ...
      {sidebarLinks.map((item, index) => {
        ...
        return (
          <Link
            ...
            } hover:btn-secondary flex items-center gap-3 rounded-none  bg-transparent p-4 px-6`}
          >
            <Image
              src={item.imgURL}
              alt={item.label}
